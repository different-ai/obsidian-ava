...
import {
    Answer,
    ArtifactType, ClassifierParameters, ImageParameters, Prompt, Request, SamplerParameters, StepParameter, TransformType
...
export const generateAsync: (
    ...
    res: ResponseData
        ...
        new Promise<{
            ...
            api.on('end', (data) => {
                if (!data.isOk) console.error(data);//return reject(new Error(data.message))
                resolve({
                    res: data,
                    images,
                })
